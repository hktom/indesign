...
class Moove_GDPR_Actions {
	...
	public function moove_gdpr_footer_branding_content() {
		...
		<a href="https://wordpress.org/plugins/gdpr-cookie-compliance" target="_blank" rel="noopener" class='moove-gdpr-branding'><?php echo esc_attr( $powered_label ); ?>&nbsp; <u><?php esc_attr_e( 'GDPR Cookie Compliance', 'gdpr-cookie-compliance' ); ?></u></a>
		<?php
		return ob_get_clean();
	}
