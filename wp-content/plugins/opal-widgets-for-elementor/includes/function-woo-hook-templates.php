        ...
        if ($time_sale) {
            ...
            echo '<div class="time">
                    <div class="opal-countdown clearfix"
                        ...
                        data-days="' . esc_html__("days", "opalelementor") . '"
                        data-hours="' . esc_html__("hours", "opalelementor") . '"
                        data-minutes="' . esc_html__("mins", "opalelementor") . '"
                        data-seconds="' . esc_html__("secs", "opalelementor") . '"
                        data-Message="' . esc_html__('Expired', 'opalelementor') . '"
...
function osf_elementor_product_loop_layouts(){
	return apply_filters(
		'osf_elementor_product_loop_layouts', array(
			    'content'       => __( 'Grid By Current Theme', 'opalelementor' ),
                'content-list'  => __( 'List Widget Style', 'opalelementor' ),
                'content-split' => __( 'Split Widget Style', 'opalelementor' ),
                'content-grid'  => __( 'Grid Widget Style', 'opalelementor' ),
		)
	);
}
